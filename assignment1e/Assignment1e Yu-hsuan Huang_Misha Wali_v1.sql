...
/*
	...
	Date: 
		June 25th, 2020
	Topic & Purpose:
		Assignment 1e - Class registration
	Description:
		Select statements (summary practice)
*/
/*
	...
	(O)	1)	Use of the function MAX or MIN on all records in the table.
	(O)	2)	Use of the function MAX or MIN on ‘groups’ of records in the table.
	(O)	3)	Use of the function AVG on all records in the table.
	(O)	4)	Use of the function AVG on ‘groups’ of records in the table.
	(O)	5)	Use of the COUNT function on all records in the table.
	(O)	6)	Use of the COUNT function on ‘groups’ of records in the table.
	(O)	7)	Use of the SUM function on all records in the table.
	(O)	8)	Use of the SUM function on ‘groups’ of records in the table.
	(O)	9)	Use of GROUP BY without the HAVING clause
	(O)	10)	Use of GROUP BY with the HAVING clause
	(O)	11)	Use of GROUP BY with the HAVING clause, yes another one
	(O)	12)	A complete SELECT statement with all clauses- FROM, WHERE, GROUP BY, HAVING, ORDER BY, LIMIT
*/

# Insert new 12 records
INSERT INTO class_registration 
VALUES
	-- ('30741', 'COMP', '1035', 'Networking Essentials', 'Toronto', 3.00, 500, '2020-05-17', '2020-08-03', 'Mon', 'A-112', 'Ali Ershad-Manesh'),
	-- ('30742', 'CPHR', '0001', 'Co-op and Career Preparation', 'Orillia', 0.00, 2500, '2020-05-18', '2020-08-04', 'Tues', 'B-214', 'Beth Salt'),
    -- ('12345', 'COMP', '1006', 'Intro to Web Prog using PHP', 'Owen Sound', 2.25, 50, '2020-05-21', '2020-08-06', 'Thur', 'Online', 'Albert Villaruz'),
	-- ('11255', 'COMP', '2003', 'Relational Database', 'Barrie', 3.00, 50, '2020-05-22', '2020-08-07', 'Fri', 'K-324', 'John White'),
    -- ('11256', 'COMP', '2003', 'Relational Database', 'Barrie', 3.00, 35, '2020-05-22', '2020-08-07', 'Fri', 'K-324', 'Anju K. Chawla'),
	-- ('11257', 'COMM', '1017', 'Work Environment Comm', 'Markham', 1.50, 1200, '2020-05-22', '2020-08-07', 'Fri', 'H-211', 'Tracey A. Bedford'),
	-- ('11258', 'COMP', '1098', '.NET Programming using C#', 'Orillia', 3.00, 150, '2020-05-18', '2020-08-03', 'Mon', 'H-227', 'Kevin Li'),
	-- ('12400', 'COMP', '1045', 'Internet of Things - Arduino', NULL, 3.00, 3000, NULL, NULL, 'Thur', 'Online', 'Matthew Wilson'),
    ('30742','MATH','1003','Math for the Computer Industry','Barrie', 3.00, 550,'2020-05-19','2020-08-04','Tues', 'N-112','Joe Clark'),
    ('11261','COMP','1008','Intro Obj Oriented Prog-Java','Barrie', 1.50, 20,'2020-05-20','2020-08-05','Wed','Online','Jeff Davis'),
	('11262','COMP','1008','Intro Obj Oriented Prog-Java','Orillia', 1.50, 200,'2020-05-20','2020-08-05','Wed','Online','Jesmine Smith'),
	('11263','COMP','1008','Intro Obj Oriented Prog-Java','Toronto', 3.00, 2000,'2020-05-20','2020-08-05','Wed','Online','Jessica Taylor'),
	('30746','COMM','1016','Communication Essentials','Marham', 1.75, 60,'2020-05-21','2020-08-06', 'Thur', 'B-101','Maria Wall'),
	('30747','COMM','1016','Communication Essentials','Toronto', 1.50, 650,'2020-05-21','2020-08-06', 'Thur', 'M-113','Eva Jackson'),
	('30748','COMM','1016','Communication Essentials','Orillia', 1.25, 1650,'2020-05-21','2020-08-06', 'Thur', 'M-123','Scott Martin'),
	('12500', 'COMP', '1002', 'HTML, CSS, & JS Fund.', 'Barrie', 3.00,  8, '2020-01-10', '2020-04-17', 'Fri', 'A-223','Julie-Ann C. Snache'),
    ('12501', 'COMP', '1002', 'HTML, CSS, & JS Fund.', 'Oakville', 3.00,  15, '2020-01-10', '2020-04-17', 'Fri', 'A-224','Joseph Brown'),
    ('12502', 'COMP', '1002', 'HTML, CSS, & JS Fund.', 'Oakville', 3.00,  350, '2020-01-10', '2020-04-17', 'Fri', 'A-225','James Grey'),
    ('12503', 'COMP', '1002', 'HTML, CSS, & JS Fund.', 'Oakville', 3.00,  900, '2020-01-10', '2020-04-17', 'Fri', 'A-226','Thomas Lee'),
    ('12504', 'COMP', '1002', 'HTML, CSS, & JS Fund.', 'Oakville', 3.00,  1899, '2020-01-10', '2020-04-17', 'Fri', 'A-227','Winnie Young');

UPDATE class_registration SET campus = 'Barrie' WHERE course_id = '30744'; 

# 1) Use of the function MAX or MIN on all records in the table.
# The max capacity of students in all course (MAX: 2000)
SELECT MAX(capacity) 'Max capacity'
FROM class_registration;

# 2) Use of the function MAX or MIN on ‘groups’ of records in the table.
# Max capacity by each course.
SELECT course_name 'Course name', MAX(capacity) 'Min capacity'
FROM class_registration
GROUP BY course_name;

# 3) Use of the function AVG on all records in the table.
# Average capacity on all course (Average: 561.88)
SELECT ROUND(AVG(capacity), 2)
FROM class_registration;

# 4) Use of the function AVG on ‘groups’ of records in the table.
# Average capacity on each course
SELECT course_name 'Course name', ROUND(AVG(capacity), 2)
FROM class_registration
GROUP BY course_name;

# 5) Use of the COUNT function on all records in the table.
# Count course amount which course name equal to 'HTML, CSS, & JS Fund.' (Count: 5)
SELECT COUNT(course_id)
FROM class_registration
WHERE course_name = 'HTML, CSS, & JS Fund.';

# 6) Use of the COUNT function on ‘groups’ of records in the table.
# Count course amount on each course name
SELECT course_name 'Course name', COUNT(course_name)
FROM class_registration
GROUP BY course_name;

# 7) Use of the SUM function on all records in the table.
# Sum capacity if course name equal to 'HTML, CSS, & JS Fund.' (SUM: 3172)
SELECT SUM(capacity)
FROM class_registration
WHERE course_name = 'HTML, CSS, & JS Fund.';

# 8) Use of the SUM function on ‘groups’ of records in the table.
# Sum capacity on each course name
SELECT course_name 'Course name', SUM(capacity)
FROM class_registration
GROUP BY course_name;

# 9) Use of GROUP BY without the HAVING clause
# Get average credits on each course name
SELECT course_name 'Course name', ROUND(AVG(credits),  2)
FROM class_registration
GROUP BY course_name;

# 10) Use of GROUP BY with the HAVING clause
# Compare course name which called 'Intro Obj Oriented Prog-Java' average credits between 'Barrie' campus and 'Orillia' compus
SELECT course_name 'Course name', campus 'Campus', ROUND(AVG(credits),  2)
FROM class_registration
WHERE course_name  = 'Intro Obj Oriented Prog-Java'
GROUP BY campus
HAVING campus IN ('Barrie', 'Orillia');

# 11) Use of GROUP BY with the HAVING clause, yes another one
# Get course which start date between 2020-05-01 and 2020-05-31 and course subject in 'COMP' and 'COMM' on each course_code, course_number
SELECT CONCAT(course_code, course_number) 'Couse code', course_name 'Course Name'
FROM class_registration
WHERE date_of_start BETWEEN CAST('2020-05-01' AS DATE) AND CAST('2020-05-31' AS DATE)
GROUP BY course_code, course_number
HAVING course_code IN ('COMP', 'COMM');


# 12) A complete SELECT statement with all clauses- FROM, WHERE, GROUP BY, HAVING, ORDER BY, LIMIT
# Get first 2 course whcih credit equal to 3 and campus on Barrie (Limit 2 records)
SELECT course_name 'Course name', campus 'Campus'
FROM class_registration
WHERE credits = 3
GROUP BY course_name, campus
HAVING campus = 'Barrie'
